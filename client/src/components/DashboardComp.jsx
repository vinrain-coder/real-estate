...
export default function DashboardComp() {
  ...
  return (
    <div className="p-3 md:mx-auto max-w-full overflow-x-auto">
      ...
      {/* Recent Users, Comments, and Listings Sections */}
              ...
              listings.map((listing) => (
                <Table.Body key={listing._id} className="divide-y">
                  <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <Table.Cell className="w-96">{listing.title}</Table.Cell>
                    <Table.Cell className="w-5">{listing.category}</Table.Cell>
                  </Table.Row>
                </Table.Body>
              ))}
          </Table>
